...
//
myapp.EditDetails.WijmoGrid_render = function (element, contentItem) {
...
myapp.EditDetails.AddNew_canExecute = function (screen) {
    return screen.TimesheetDetails.isLoaded;
};

myapp.EditDetails.AddNew_execute = function (screen) {
    //screen.TimesheetDetails.addNew();
    //grid.EntityChanged(msls.EntityState.added);
};

myapp.EditDetails.DeleteSelected_canExecute = function (screen) {
    $(".msls-footer").removeClass("slideup");
    return screen.TimesheetDetails.selectedItem != null;
};

myapp.EditDetails.DeleteSelected_execute = function (screen) {
