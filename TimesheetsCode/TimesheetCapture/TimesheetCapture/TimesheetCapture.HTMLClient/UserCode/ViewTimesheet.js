...
//
myapp.ViewTimesheet.TimesheetDetails_render = function (element, contentItem) {
...
myapp.ViewTimesheet.AddNew_canExecute = function (screen) {
    return screen.TimesheetDetails.isLoaded;
};

myapp.ViewTimesheet.AddNew_execute = function (screen) {
    screen.TimesheetDetails.addNew();
    grid.EntityChanged(msls.EntityState.added);
};

myapp.ViewTimesheet.DeleteSelected_canExecute = function (screen) {
    $(".msls-footer").removeClass("slideup");
    return screen.TimesheetDetails.selectedItem != null;
};

myapp.ViewTimesheet.DeleteSelected_execute = function (screen) {
