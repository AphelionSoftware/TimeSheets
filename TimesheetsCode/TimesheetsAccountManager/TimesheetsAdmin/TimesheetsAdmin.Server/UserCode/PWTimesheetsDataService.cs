...
namespace LightSwitchApplication
{
    public partial class PWTimesheetsDataService
    {
        ...
        partial void Projects_Filter(ref Expression<Func<Project, bool>> filter)
        {
            ...
            filter = (e => this.Application.User.Identity.Name.EndsWith(e.Client.Person.ADUsername)
        ...
        partial void Clients_Filter(ref Expression<Func<Client, bool>> filter)
        {
            ...
            filter = (e => this.Application.User.Identity.Name.EndsWith(e.Person.ADUsername)
        ...
        {
            // filter = e => e.IntegerProperty == 0;
            filter = (e => this.Application.User.Identity.Name.EndsWith(e.Project.Client.Person.ADUsername)
