...
namespace LightSwitchApplication
{
    public partial class Timesheets_DataService
    {
        ...
        {
            entity.sys_CreatedBy = this.Application.User.PersonId /*"MarkGStacey"*/;
            entity.sys_CreatedOn = System.DateTime.Now;
            entity.sys_ModifiedBy = this.Application.User.PersonId /*"MarkGStacey"*/;
        ...
        partial void Projects_Filter(ref Expression<Func<Project, bool>> filter)
        {
            ...
            filter = (e => this.Application.User.PersonId.StartsWith(e.Client.Person.SharepointUserName)
                        || Environment.UserName.EndsWith(e.Client.Person.SharepointUserName)
                        || this.Application.User.PersonId.StartsWith(e.Client.Person.ADUsername)
                        || Environment.UserName.EndsWith(e.Client.Person.ADUsername)
                        || this.Application.User.PersonId.Contains("markgstacey")
        ...
        partial void Clients_Filter(ref Expression<Func<Client, bool>> filter)
        {
            ...
            filter = (e => this.Application.User.PersonId.StartsWith(e.Person.SharepointUserName)
                        || Environment.UserName.EndsWith(e.Person.SharepointUserName)
                        || this.Application.User.PersonId.StartsWith(e.Person.ADUsername)
        ...
        {
           // filter = (e => this.Application.User.PersonId.StartsWith( e.TimesheetDetails.c  );
        ...
        {
            // filter = e => e.IntegerProperty == 0;
            filter = (e => this.Application.User.PersonId.StartsWith(e.Project.Client.Person.SharepointUserName)
                        || Environment.UserName.EndsWith(e.Project.Client.Person.SharepointUserName)
                        || this.Application.User.PersonId.StartsWith(e.Project.Client.Person.ADUsername)
                        || Environment.UserName.EndsWith(e.Project.Client.Person.ADUsername)
                        || this.Application.User.PersonId.Contains("markgstacey")
                        || Environment.UserName.Contains("markgstacey")
                        || this.Application.User.PersonId.StartsWith(e.Project.Person.SharepointUserName)
                        || Environment.UserName.EndsWith(e.Project.Person.SharepointUserName)
                        || this.Application.User.PersonId.StartsWith(e.Project.Person.ADUsername)
                        || Environment.UserName.EndsWith(e.Project.Person.ADUsername)
                        );
        ...
        {
            // filter = e => e.IntegerProperty == 0;
            filter = (e => this.Application.User.PersonId.StartsWith(e.SharePointUserName)
                        || Environment.UserName.EndsWith(e.SharePointUserName)
                        || this.Application.User.PersonId.StartsWith(e.ADUserName)
