...
myapp.Invoice.created = function (entity) {
    ...
    myapp.activeDataWorkspace.TimesheetsData.DimDates_SingleOrDefault(todayDateID).execute().then(function (DateQuery) {
    ...
    myapp.activeDataWorkspace.TimesheetsData.InvoiceStatus_SingleOrDefault(1).execute().then( function (InvQuery) {
