...
(function (lightswitchTools, undefined) {
    ...
    lightswitchTools.configureCaptureForm = function (screen) {
        ...
        if (primaryKey === undefined) {
            ...
            newDataWorkspace.TimesheetData[pluralName(name)].filter(primaryKeyColumn + " eq " + primaryKey).execute().then(function (result) {
    ...
    lightswitchTools.deleteEntity = function (screen) {
        ...
        msls.showMessageBox("Are you sure you want to delete this record", {
            ...
            if (result === msls.MessageBoxResult.yes) {
                screen.details.dataWorkspace.TimesheetData.ActiveTypes.filter("Code eq 'Deleted'").execute().then(function (x) {
