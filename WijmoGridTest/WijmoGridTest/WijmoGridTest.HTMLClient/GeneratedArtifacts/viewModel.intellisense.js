...
(function (lightSwitchApplication) {
    ...
    msls._addEntryPoints(lightSwitchApplication.AddEditSalesOrderDetail, {
        /// <field>
        /// Called when a new AddEditSalesOrderDetail screen is created.
        /// <br/>created(msls.application.AddEditSalesOrderDetail screen)
        /// </field>
        created: [lightSwitchApplication.AddEditSalesOrderDetail],
        /// <field>
        /// Called before changes on an active AddEditSalesOrderDetail screen are applied.
        /// <br/>beforeApplyChanges(msls.application.AddEditSalesOrderDetail screen)
        /// </field>
        beforeApplyChanges: [lightSwitchApplication.AddEditSalesOrderDetail],
        /// <field>
